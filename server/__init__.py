...
def init_flask_restful_routes(app):
    ...
    from server.api.mapillary_api import MapillaryTasksAPI, SequencesAsGPX
    ...
    api.add_resource(MappingIssuesAPI,              '/api/v1/mapping-issues/<int:project_id>/<detailed_view>')
    ...
    api.add_resource(MapillaryTasksAPI,             '/api/v1/admin/mapillary-tasks')
    api.add_resource(SequencesAsGPX,                '/api/v1/project/<int:project_id>/sequences-as-gpx')
